...
$LANG['SUBJECT_ID_REQUIRED'] = 'ERROR: subject identifier required (occid, catalogNumber, occurrenceID, otherCatalogNumbers)';
$LANG['OBJECT_ID_REQUIRED'] = 'ERROR: object identifier required  (occid, catalogNumber, occurrenceID, occid)';
$LANG['IDENTIFIER_NAME_REQUIRED'] = 'ERROR: identifier name required';
$LANG['IDENTIFIER_ID_VALUE_REQUIRED'] = 'ERROR: identifier value required';
...
$LANG['TARGET_NOT_FOUND'] = 'Update failed: no existing association found';
...
$LANG['IDENTIFIER_UPDATE_OR_DELETE'] = 'Update identifiers with matching occid, occurrenceID, catalogNumber, or otherCatalogNumber plus identifierName';
