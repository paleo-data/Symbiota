...
$LANG['ANN_LAB_MAN'] = 'Gestionnaire d\'étiquettes d\'annotation';
$LANG['SEL_ANN'] = 'Veuillez sélectionner au moins un enregistrement d\'annotation !';
...
$LANG['DETERMINATION'] = 'Détermination';
$LANG['ANN_PRINT'] = 'Impression des annotations';
$LANG['HEADER'] = 'En-tête';
$LANG['FOOTER'] = 'Pied de page';
$LANG['PRINT_INF_AUTH'] = 'Imprimer les auteurs des espèces pour les taxons infraspécifiques';
$LANG['PRINT_CATNUM'] = 'Imprimer les numéros de catalogue';
$LANG['REM_ANNO'] = 'Supprimer les annotations sélectionnées de la file d\'attente';
$LANG['BORDER_WIDTH'] = 'Largeur de la bordure';
$LANG['COLUMNS_PER_PAGE'] = 'Colonnes par page';
$LANG['SPACE_BW_LABELS'] = 'Espacement entre les étiquettes';
$LANG['PRINT_IN_BROWSER'] = 'Imprimer dans le navigateur';
