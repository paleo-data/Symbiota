...
$LANG['SAMPLE_PROPERTIES'] = 'Propiedades de Muestra/Observación';
...
$LANG['LAT_LONG_SEARCH_EXPLAIN'] = '<b>Nota:</b> la búsqueda de registros utilizando cualquiera de los siguientes criterios solo devolverá registros para los que se hayan proporcionado valores de latitud y longitud (es decir, solo se buscarán registros georreferenciados).';
$LANG['BOUNDING_BOX'] = 'Cuadro Delimitador';
$LANG['SELECT_IN_MAP'] = 'Mapear Cuadro Delimitador';
$LANG['UPPER_LATITUDE'] = 'Latitud Superior';
$LANG['VALUE_BETWEEN_NUM'] = 'Valores entre 0 y 90.';
...
$LANG['VALUES_BETWEEN_0_TO_180'] = 'Valores entre 0 y 180.';
...
$LANG['SELECT_MAP_POLYGON'] = 'Mapear Polígono';
$LANG['POLYGON'] = 'Polígono';
$LANG['GEOJSON_FORMAT'] = 'El polígono debe estar en formato GeoJSON';
$LANG['SELECT_MAP_BUTTON_PASTE'] = 'Seleccionar en el mapa con el botón o pegar valores.';
$LANG['POINT_RADIUS'] = 'Punto-Radio';
$LANG['SELECT_MAP_PR'] = 'Mapear Punto-Radio';
...
$LANG['COLLECTOR_NAME'] = 'Apellido del Colector';
...
$LANG['POINT_LONG'] = 'Longitud del Punto';
$LANG['UPPER_HEMI'] = 'Hemisferio Superior';
$LANG['BOTTOM_HEMI'] = 'Hemisferio Inferior';
$LANG['LEFT_HEMI'] = 'Hemisferio Izquierdo';
$LANG['RIGHT_HEMI'] = 'Hemisferio Derecho';
$LANG['POINT_LAT_HEMI'] = 'Latitud del punto del hemisferio';
$LANG['POINT_LONG_HEMI'] = 'Longitud del punto del hemisferio';
...
$LANG['NO_POLYGONS_FOUND'] = 'No se encontraron polígonos que se puedan buscar en el tesauro.';
