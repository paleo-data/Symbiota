...
<body>
	...
	<div id="innertext">
		...
		<p>By using data in this portal, you are agreeing to give attribution to data providers according to the licenses and usage rights specified in the relevant collection profile(s). When in doubt, reach out to the relevant <a href="https://biokic.github.io/symbiota-docs/user/contact/" target="_blank" rel="noopener noreferrer">listed contact(s)</a> for more information. Additionally:</p>
			<ul>
