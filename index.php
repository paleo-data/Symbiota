...
<body>
	...
	<div id="innertext">
		...
		elseif($LANG_TAG == 'fr'){
			...
			<h1>Welcome</h1>
				<p>
					<strong>Welcome to the Paleo Data Portal!</strong> This <a href="https://github.com/Symbiota/Symbiota" target="_blank" rel="noopener noreferrer">Symbiota-based</a> data portal is being developed as part of the project, <em>Community-driven enhancement of information ecosystems for the discovery and use of paleontological specimen data</em> (NSF Awards <a href="https://www.nsf.gov/awardsearch/showAward?AWD_ID=2324688" target="_blank" rel="noopener noreferrer">2324688</a>, <a href="https://www.nsf.gov/awardsearch/showAward?AWD_ID=2324689" target="_blank" rel="noopener noreferrer">2324689</a>, and <a href="https://www.nsf.gov/awardsearch/showAward?AWD_ID=2324690" target="_blank" rel="noopener noreferrer">2324690</a>/<a href="https://www.nsf.gov/awardsearch/showAward?AWD_ID=2525603" target="_blank" rel="noopener noreferrer">2525603</a>). This project is a collaboration between the Symbiota Support Hub (University of Kansas), the Smithsonian National Museum of Natural History, and the University of Colorado Museum of Natural History. During the current funding cycle, the objectives of this portal are to 1) provide paleontological collections with a low-barrier-to-entry platform for data mobilization and management, and 2) serve as an evaluation and implementation testing ground for many of the cyberinfrastructure developments identified as part of the aforementioned project.
				</p>
			<h2>Portal scope</h2>
				<p>
					This data portal supports the management and sharing of data associated with paleontological specimens that are made available for research via permanent repositories. Its scope is limited to extinct organisms and their traces (i.e., fossils). Geological samples, archaeological and anthropological materials, as well as neontological specimen data fall outside this scope and should not be cataloged in this portal.
				</p>
			<h2>How to contribute data</h2>
				<p>
					This data portal is primarily for fossil collections that intend to actively manage specimen occurrence records within this data portal. <strong>Publicly accessible research collections that have not directly benefited from the <a href="https://new.nsf.gov/funding/opportunities/advancing-digitization-biodiversity-collections/503559" target="_blank" rel="noopener noreferrer">US National Digitization effort</a>, and/or do not have access to secure cyberinfrastructure to maintain their specimen data are especially encouraged to participate.</strong> Prospective data providers should review the portal's <a href="<?php echo $CLIENT_ROOT; ?>/includes/usagepolicy.php" target="_blank" rel="noopener noreferrer">community guidelines</a> and <a href="https://paleo-data.github.io/knowledge-hub/how-to-guides/start-using-symbiota" target="_blank" rel="noopener noreferrer">associated documentation</a> before <a href="https://forms.gle/9hrYpRYxTN4pforz9" target="_blank" rel="noopener noreferrer">applying to join</a>.
				</p>
				<p>
					In order to maximize the interoperability and research utility of the data managed in this portal, <strong>data contributors are encouraged to participate in the <a href="https://paleo-data.github.io/#how-to-get-involved" target="_blank" rel="noopener noreferrer">Paleo Data Working Group (PDWG)</a></strong>, a community of practice for paleontological collections and informatics professionals who aim to develop and promote best practices for managing and digitizing fossil specimens.
				</p>
			<h2>A note for data users</h2>
				<p>
					Each portal user should review the relevant <a href="<?php echo $CLIENT_ROOT; ?>/includes/usagepolicy.php#users" target="_blank" rel="noopener noreferrer">community guidelines</a> and is encouraged to create <a href="<?php echo $CLIENT_ROOT; ?>/profile/newprofile.php" target="_blank" rel="noopener noreferrer">a user profile</a>. Maintaining a user profile will maximize your ability to take advantage of the portal's <a href="https://docs.symbiota.org/User_Guide/" target="_blank" rel="noopener noreferrer">built-in tools</a> for data discovery.
				</p>
			</div>
			<?php
		}
