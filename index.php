			...
			<h1>Welcome</h1>
				<p>
					...
					During the current funding cycle, the objectives of this portal will be to 1) provide paleontological collections with a low-barrier-to-entry platform for data mobilization and management, and 2) serve as an evaluation and implementation testing ground for many of the cyberinfrastructure developments identified as part of the aforementioned project. Once fully installed, this data portal will be available as a <strong>data aggregator</strong> and <strong>collections management system</strong> for fossil specimen data.
						<br><br>
					This <a href="">Symbiota-based</a> portal is primarily for fossil collections that intend to actively manage specimen occurrence records within this data portal. <strong>Publicly accessible research collections that have not directly benefited from the <a href="https://new.nsf.gov/funding/opportunities/advancing-digitization-biodiversity-collections/503559">US National Digitization effort</a>, and/or do not have access to secure cyberinfrastructure to maintain their specimen data are especially encouraged to participate.</strong> Because Symbiota is best leveraged as a collaborative digitization tool benefiting from increased community participation, collections that simply wish to share a copy of their data will also be welcome to contribute. Prospective data providers are strongly encouraged to review the portal's official <a href="">Community Guidelines</a> and may apply by completing <a href="https://forms.gle/tdLpXzpoTxxaqc1C9">this form</a>.
				</p>
			<h1>Community Support</h1>
				<p>
					In order to maximize the interoperability and research utility of the data managed in this portal, <strong>data contributors will be encouraged to participate in the <a href="https://paleo-data.github.io/#how-to-get-involved">Paleo Data Working Group (PDWG)</a></strong>, a community of practice for paleontological collections and informatics professionals who aim to develop and promote best practices for managing and digitizing fossil specimens. Further guidance for portal data contributors will be provided by a forthcoming <strong>Community Knowledge Hub</strong> intended to document related best practices based on the requirements-gathering activities of PDWG and the aforementioned NSF Awards (#2324688–90).
				</p>
			<h1>Technical Support</h1>
				<p>Technical assistance and <a href="https://symbiota.org/help-resources/">Symbiota-related resources</a> for this portal community are provided by the <a href="https://symbiota.org/contact-the-support-hub/">Symbiota Support Hub</a>.
				</p>
				</div>
			<?php
		}
